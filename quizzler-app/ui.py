...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: 0", foreground="white", bg=THEME_COLOR, font=("Arial", 10, "italic"))
        self.score_label.grid(column=1, row=0)

        self.canvas = Canvas(width=300, height=250, bg="White", highlightthickness=0)
        self.text = self.canvas.create_text(150, 125, text="Hola", width=280, fill="black", font=("Arial", 20, "italic"))
